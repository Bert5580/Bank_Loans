...
Config.NPCSpawnLocations = {
    ...
    vector4(-2961.08, 483.4, 15.7, 90.06)  -- LS-FB NPC spawn location with heading (uncomment if needed)
}
...
-- Loan Options
Config.LoanOptions = {
    {amount = 5000, interestRate = 0.02},   -- Loan of $5000 with 2% interest
    {amount = 10000, interestRate = 0.03}, -- Loan of $10000 with 3% interest
    {amount = 20000, interestRate = 0.04}, -- Loan of $20000 with 4% interest
    {amount = 50000, interestRate = 0.05}, -- Loan of $50000 with 5% interest
    {amount = 80000, interestRate = 0.06}, -- Loan of $80000 with 6% interest
    {amount = 100000, interestRate = 0.07},-- Loan of $100000 with 7% interest
    {amount = 150000, interestRate = 0.08},-- Loan of $150000 with 8% interest
    {amount = 200000, interestRate = 0.09},-- Loan of $200000 with 9% interest
    {amount = 250000, interestRate = 0.10},-- Loan of $250000 with 10% interest
    {amount = 500000, interestRate = 0.11},-- Loan of $500000 with 11% interest
    {amount = 750000, interestRate = 0.12},-- Loan of $750000 with 12% interest
    {amount = 850000, interestRate = 0.13},-- Loan of $850000 with 13% interest
    {amount = 100000000, interestRate = 0.14} -- Loan of $100000000 with 14% interest
}

-- Paycheck Interval and Payback Percentage
Config.PaycheckInterval = 600000 -- Paycheck every 10 minutes (milliseconds)
